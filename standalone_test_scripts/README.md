...
| [stream_toggle_stress_test](stream_toggle_stress_test/README.md) | Toggle individual or all camera streams and verify global recovery | Single/multi-camera with JPG evidence; individual mode supports ROS1/ROS2, all mode is currently ROS2 only |
